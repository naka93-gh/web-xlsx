...
describe('stylesXml', () => {
  it('XML 宣言と styleSheet ルート（main 名前空間）を出力する', () => {
  ...
  it('日付用 numFmt 164 のとき yyyy-mm-dd を出力する', () => {
    expect(XML).toContain('<numFmt numFmtId="164" formatCode="yyyy-mm-dd"/>')
  })

  it('既定(0)・日付・ヘッダーの 3 つの cellXfs を出力する', () => {
